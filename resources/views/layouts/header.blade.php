                ...
                <li class="nav-item dropdown dropdown-user-setting">
                    <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="javascript:;"
                        ...
                        <div class="user-setting">
                            <img src="{{ url(Auth::user()->avatar) }}" class="user-img" alt="">
                        </div>
                    </a>
                            ...
                            <a class="dropdown-item" href="javascript:;">
                                <div class="d-flex flex-row align-items-center gap-2">
                                    <img src="{{ url(Auth::user()->avatar) }}" alt="" class="rounded-circle"
                                        width="54" height="54">
                                    <div class="">
                                        <h6 class="mb-0 dropdown-user-name text-capitalize">{{ Auth::user()->name }}</h6>
                                        <small class="mb-0 dropdown-user-designation text-secondary">Superadmin</small>
                                    </div>
                                </div>
                            </a>
                        </li>
